...
',
    ...
    reload: function (shopId, selectedProductIds) {
        ...
        $("#_shopProductSelector table").TaoLaDatagrid({
            url: url,
            nowrap: false,
            rownumbers: true,
        ...
        $("#_shopProductSelector .choose-search button").unbind('click').click(function () {
            ...
            $("#_shopProductSelector table").TaoLaDatagrid('reload', $.shopProductSelector.params);
        });
    ...
    getSelected: function () {
        ...
        if (this.multiSelect) {
            ...
            products.push($("#_shopProductSelector table").TaoLaDatagrid('getSelected'));
        }
    ...
    show: function (selectedProductIds, onSelectFinishedCallBack, shopId, multiSelect) {
        ...
        $('#_shopProductSelector select').TaoLaLinkage({
            ...
            onChange: function (level, value) {
                ...
                if (level > 0 && !value) {
                    ...
                    categoryId = $('#_shopProductSelector select').TaoLaLinkage('value', parentLevel);
