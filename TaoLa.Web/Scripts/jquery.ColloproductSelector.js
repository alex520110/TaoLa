$.productSelector = {
    params: { auditStatus: 2, saleStatus: 1, selectedProductIds: [], isShopCategory: false,showSku: true},
    serviceType: 'admin',
    multiSelect:true ,
    selectedProducts: [],
...
',
    ...
    loadedProducts:null,
    reload: function (selectedProductIds) {
        this.loadedProducts = [];
        var url;
        ...
        $("#_productSelector table").TaoLaDatagrid({
            url: url,
            nowrap: false,
            rownumbers: true,
        ...
        $("#_productSelector .choose-search button").unbind('click').click(function () {
            ...
            $("#_productSelector table").TaoLaDatagrid('reload', $.productSelector.params);
        });
    ...
    getSelected:function(){
        ...
        if (this.multiSelect) {
            ...
            products.push($("#_productSelector table").TaoLaDatagrid('getSelected'));
        }
        return products;
    },
    show: function (selectedProductIds, onSelectFinishedCallBack, serviceType,multiSelect) {
        ...
        $('#_productSelector select').TaoLaLinkage({
            url: curl,
            ...
            onChange: function (level, value) {
                ...
                if (level > 0 && !value)
                {
                    ...
                    categoryId = $('#_productSelector select').TaoLaLinkage('value', parentLevel);
        ...
        this.clear();
        this.reload(selectedProductIds);
