...
',
    ...
    reload: function (selectedShopIds) {
        ...
        $("#_shopSelector table").TaoLaDatagrid({
            url: url,
            nowrap: false,
            rownumbers: true,
        ...
        $("#_shopSelector .choose-search button").unbind('click').click(function () {
            ...
            $("#_shopSelector table").TaoLaDatagrid('reload', $.sellerSelector.params);
        });
    ...
    getSelected: function () {
        ...
        if (this.multiSelect) {
            ...
            shops.push($("#_shopSelector table").TaoLaDatagrid('getSelected'));
        }
        return shops;
    },
