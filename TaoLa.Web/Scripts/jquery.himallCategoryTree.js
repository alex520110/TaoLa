(function ($) {
    ...
    function initLoad() {
        var html = '';
        initTable();
        $.post($.fn.TaoLaCategoryTree.options.dataUrl, { parentId: 0 }, function (data) {
    ...
    $.fn.TaoLaCategoryTree = function (options) {
        container = $(this);
        $.fn.TaoLaCategoryTree.options = $.extend({}, $.fn.TaoLaCategoryTree.options, options);
