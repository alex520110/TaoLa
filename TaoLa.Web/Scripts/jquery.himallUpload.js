...
(function ($) {
	...
	$.fn.TaoLaUpload = function (options, param) {
	    if (typeof options == "string") {
	        return $.fn.TaoLaUpload.methods[options](this, param);
	    }
	    options = options || {};
	    return this.each(function () {
	        var opts = $.extend({}, $.fn.TaoLaUpload.defaults, options);
	        opts.view.render.call(opts.view, opts, $(this));
	        bindEvent(this, opts);
	    });
	};

	$.fn.TaoLaUpload.methods = {
	...
	var renderView = {
		render: function (opts, container) {
			var html = [
                '<label class="col-sm-' + opts.headerWidth+ ' control-label" for="">' + opts.title + '</label><input class="hiddenImgSrc" type="hidden" value="' + opts.displayImgSrc + '"  name="' + opts.imgFieldName + '">',
