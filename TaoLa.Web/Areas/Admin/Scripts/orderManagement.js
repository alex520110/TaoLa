...
$(function () {
    ...
    $("#list").hiMallDatagrid({
        ...
        pagePosition: 'bottom',
        pageNumber: 1,
        queryParams: { orderStatus: status , selectPaymentType : 0 },
        columns:
        [[
            {
            ...
            { field: "UserName", title: "买家", width: 120, align: "center" },
        ...
        { field: "PaymentTypeStr", title: "支付方式", width: 80, align: "center" },
    ...
    $('#searchButton').click(function (e) {
        ...
        $( "#list" ).hiMallDatagrid( 'reload', { startDate: startDate, endDate: endDate, orderId: orderId, shopName: shopName, userName: userName, paymentTypeGateway: paymentTypeGateway, selectPaymentType: selectPaymentType } );
    })
    ...
    $('.nav li').click(function (e) {
        ...
        {//状态分类
            ...
            $('#txtShopName').val('');
            $('#txtuserName').val('');
            $( "#list" ).hiMallDatagrid( 'reload', { orderStatus: $( this ).attr( 'value' ) || null, pageNumber: 1, startDate: '', endDate: '', orderId: '', shopName: '', userName: '', paymentTypeGateway: '' , selectPaymentType : '' } );
        }
    });
});
