...
namespace Himall.Model
{
	public class WX_MsgTemplateSendDataModel
	{
		...
		public WX_MSGItemBaseModel keyword3
		{
			get;
			set;
		}

		public WX_MSGItemBaseModel keyword4
		{
			get;
			set;
		}

		public WX_MSGItemBaseModel keyword5
		{
			get;
			set;
		}

		public WX_MSGItemBaseModel keyword6
		{
			get;
			set;
		}

		public WX_MSGItemBaseModel keyword7
		{
			get;
			set;
		}

		public WX_MSGItemBaseModel keyword8
		{
			get;
			set;
		}

		public WX_MSGItemBaseModel keyword9
		{
			get;
			set;
		}
