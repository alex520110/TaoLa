...
namespace TaoLa.Core
{
    public class WebHelper
    {
        ...
        public static void SetCookie(string name, string value, System.DateTime dt)
        {
            HttpCookie httpCookie = HttpContext.Current.Request.Cookies[name];
            if (httpCookie == null)
            {
        ...
        public static void SetCookie(string name, string key, string value, System.DateTime dt)
        {
            HttpCookie httpCookie = HttpContext.Current.Request.Cookies[name];
            if (httpCookie == null)
            {
        ...
        {
            NameValueCollection nameValueCollection = new NameValueCollection(System.StringComparer.OrdinalIgnoreCase);
        ...
        {
            return WebHelper.GetRequestData(url, method, postData, System.Text.Encoding.UTF8);
        }

        public static string GetRequestData(string url, string method, string postData, System.Text.Encoding encoding)
        {
            return WebHelper.GetRequestData(url, method, postData, encoding, 20000);
        }

        public static string GetRequestData(string url, string method, string postData, System.Text.Encoding encoding, int timeout)
        {
            string result;
            try
            {
                using (HttpWebResponse uRLResponse = WebHelper.GetURLResponse(url, method, postData, encoding, timeout))
                {
                    ...
                    else if (encoding == null)
                    {
                        ...
                        if (uRLResponse.ContentEncoding != null && uRLResponse.ContentEncoding.Equals("gzip", System.StringComparison.InvariantCultureIgnoreCase))
                        {
                        ...
                        string @string = System.Text.Encoding.Default.GetString(array, 0, array.Length);
                        ...
                        {
                            encoding = System.Text.Encoding.GetEncoding(uRLResponse.CharacterSet);
                        }
                    ...
                    else
                    {
                        ...
                        if (uRLResponse.ContentEncoding != null && uRLResponse.ContentEncoding.Equals("gzip", System.StringComparison.InvariantCultureIgnoreCase))
                        {
                            streamReader = (streamReader2 = new System.IO.StreamReader(new GZipStream(uRLResponse.GetResponseStream(), CompressionMode.Decompress), encoding));
                            try
                            {
                        ...
                        streamReader = (streamReader2 = new System.IO.StreamReader(uRLResponse.GetResponseStream(), encoding));
                        try
                        {
                            result = streamReader.ReadToEnd();
                        }
        ...
        public static HttpWebResponse GetURLResponse(string url, string method = "get", string postData = "", System.Text.Encoding encoding = null, int timeout = 20000)
        {
            if (encoding == null)
            {
                encoding = System.Text.Encoding.UTF8;
